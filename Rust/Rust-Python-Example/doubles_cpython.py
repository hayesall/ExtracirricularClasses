...
def test_solve_count_doubles_rust():
    assert cpython_myrustlib.count_doubles(val) == _ANSWER


def test_solve_count_doubles_once_rust():
    assert cpython_myrustlib.count_doubles_once(val) == _ANSWER


def test_solve_c_bytes_once():
    assert cpython_myrustlib.count_doubles_once_bytes(val) == _ANSWER


def test_solve_rust_slice():
    assert cpython_myrustlib.count_doubles_slice(val) == _ANSWER


def test_solve_rust_slice_parallel():
    assert cpython_myrustlib.count_doubles_slice_parallel(val) == _ANSWER
...
def test_rust(benchmark):
    print(benchmark(cpython_myrustlib.count_doubles, val))


def test_rust_once(benchmark):
    print(benchmark(cpython_myrustlib.count_doubles_once, val))


def test_rust_count_doubles_once_bytes(benchmark):
    print(benchmark(cpython_myrustlib.count_doubles_once_bytes, val))


def test_rust_slice(benchmark):
    print(benchmark(cpython_myrustlib.count_doubles_slice, val))


def test_rust_slice_parallel(benchmark):
    print(benchmark(cpython_myrustlib.count_doubles_slice_parallel, val))
